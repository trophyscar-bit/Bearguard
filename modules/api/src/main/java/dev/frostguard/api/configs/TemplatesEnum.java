...
public enum TemplatesEnum {
    ...
    GAME_HOME_RECONNECT, GAME_START_DOWNLOAD_NOW, QUIT_GAME_DIALOG, GAME_START_WELCOME_BACK_TITLE,
    GAME_START_WELCOME_BACK_CONFIRM_BUTTON, GAME_START_MANDATORY_UPDATE_TITLE, GAME_START_MANDATORY_UPDATE_BUTTON,
    GAME_START_CLOSEABLE_OVERLAY_CLOSE, GAME_HOME_NEW_SURVIVORS, GAME_HOME_NEW_SURVIVORS_WELCOME_IN,
    GAME_HOME_NEW_SURVIVORS_PLUS_BUTTON, GAME_HOME_BOTTOM_BAR_SHOP_BUTTON,
